...
public class CreatingCourierTest {
    ...
    public void successCreatingCourierTest() throws JsonProcessingException {
        ...
        assertThat("Courier cannot created", response, is(notNullValue()));
    }

    @DisplayName("Check status code of /api/v1/courier - unSuccess Creating Courier With Existing Login")
    @Test
    public void unSuccessCreatingCourierWithExistingLoginTest() throws JsonProcessingException {
        ...
        assertThat("Courier can created with existing login", response, is(notNullValue()));

    }

    @DisplayName("Check status code of /api/v1/courier - unSuccess Creating Courier Without FirstName")
    @Test
